...
class Video:
    ...
    def extractMetadata(self):
        ...
        pipe = sp.Popen(cmd, stdout=sp.PIPE, stderr=sp.PIPE, universal_newlines=True, shell=True)
...
class Cmd:
    ...
    def setResolution(self, w, h):
        ...
        self.setOutput("/home/jakob/gitclones/abrlab/support")
...
def extractAudio(video):
    ...
    sp.Popen(str(cmd), stdout=sp.PIPE, stderr=sp.PIPE, universal_newlines=True, shell=True).communicate()
...
def multiEncode(video):
    for i, r in enumerate(resolutions):
        ...
        print('===================================================')
        p = sp.Popen(str(cmd), stdout=sp.PIPE, stderr=sp.PIPE, universal_newlines=True, shell=True)
        p.communicate()
